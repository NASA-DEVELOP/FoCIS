...
Parameters for hemlock distribution model (listed in handoff folder as FoCIS-L8_NYS and FoCIS_L8_APIPP for those using Landsat and FoCIS_S2_NYS and FoCIS_S2_APIPP for those using Sentinel)
------------------------------------------
...
Model Steps:
------------
1) Import all parameters listed above -- outside dataset using the code below and GEE datasets from API search bar and import feature

copy and paste this code into the top of the script to call the outside datasets:
The data is also provided in the handoff package
...
---at this point, clicking "run" will run the code and the following steps are included in the script and don't require action from the user---
...
Copy and paste this code to call the outside datasets, and use the search bar to find those that are in Earth engine.
